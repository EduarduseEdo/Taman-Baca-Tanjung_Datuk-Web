                        ...
                        <div class="col-md-12">
                            <div class="panel panel-info">
								...
								<div class="panel-body"style='padding-top:20px'>
											<form role="form" method='POST' action='<?php echo base_url("mesin/input"); ?>' enctype='multipart/form-data'>
												<?php
												$csrf = array(
												...
												<div class="form-group">
													...
													<input class="form-control" name='kode_mesin' placeholder="Kode Mesin" required autofocus>
												</div>
												</div>
												<div class="col-sm-6">
												<div class="form-group">
													<label>Nama Mesin</label>
													<input class="form-control" name='nama_mesin' placeholder="Nama Mesin" required>
												</div>
												</div>
												</div>
